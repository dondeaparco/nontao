...
kvs = KafkaUtils.createStream(ssc, "sandbox.hortonworks.com:2181", "spark_streaming", {"inter_transact": 1})
kvs.map(lambda x : x[1]).pprint()
ssc.start()

ssc.awaitTermination()'''

#Cargar el dicionario de Lemas para el lematizador
lemasRDD = sc.textFile('/opt/nontao/lema.csv')
